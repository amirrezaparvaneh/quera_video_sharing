...
git clone [https://github.com/amirrezaparvaneh/quera_video_sharing.git](https://github.com/amirrezaparvaneh/quera_video_sharing.git)
...
بعد از اینکه گپ‌کد این تغییر را انجام داد و فایل را ذخیره کرد، کافی است این دستورات را در ترمینال بزنی تا فایل اصلاح‌شده در گیت‌هاب ثبت شود:

```bash
git add README.md
git commit -m "docs: format code blocks in README.md"
